...
import PullDownBar from "../../../lib/components/search/PullDownBar";

export default function SearchLayout() {
  const { recentSearches } = useContext(SearchContext);
  ...
  return (
    <ImageBackground
      source={require("@/lib/assets/images/unm_pattern(1).png")}
      style={{ flex: 1, width: "100%", height: "100%" }}
      resizeMode="cover"
    >
      <PullDownBar recentSearches={recentSearches} quieried={isQueried} />
